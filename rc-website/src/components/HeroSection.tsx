...
export const HeroSection = () => {
  ...
  const topLeftGlowPosition = {
    ...
    scale: 1 + (
      normalizedX > 0.1 && normalizedX < 0.4 && 
      normalizedY > 0.1 && normalizedY < 0.4 ? 0.15 : 0
    )
  };
  ...
  const bottomRightGlowPosition = {
    ...
    scale: 1 + (
      normalizedX > 0.6 && normalizedX < 0.9 && 
      normalizedY > 0.6 && normalizedY < 0.9 ? 0.15 : 0
    )
  };
    ...
    <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div 
          ...
          style={{ 
            transform: `translate(calc(${normalizedX * 40 - 20}px), calc(${normalizedY * 40 - 20}px)) scale(${topLeftGlowPosition.scale})`
          }}
        ></div>
        ...
        <div 
          ...
          style={{ 
            transform: `translate(calc(${normalizedX * 40 - 20}px), calc(${normalizedY * 40 - 20}px)) scale(${bottomRightGlowPosition.scale})`
          }}
        ></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-2xl mx-auto">
            We are a collective of robotics and AI enthusiasts pushing the boundaries throgh .
          </p>
