    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative w-full h-[50vh] min-h-[400px] overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-end pb-12 relative z-10">
          <Link href="/projects">
            <Button variant="outline" className="mb-6 flex items-center gap-2 text-white border-white/20 bg-black/30 backdrop-blur-sm hover:bg-black/50">
              <ArrowLeft size={16} />
              Back to Projects
            </Button>
          </Link>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-card rounded-xl p-8">
            ...
            <p className="text-gray-300 mb-6">Want to learn more about this project or contribute to its development? We're always looking for collaborators and fresh perspectives.</p>
